...
def train_xgboost(X_train: Any, y_train: Any, param_grid: dict | None = None) -> Any:
    ...
    """
    # TODO: build an XGBRegressor model and optional GridSearchCV tuning.
    return None
